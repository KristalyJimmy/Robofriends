export const robots = [
    {id: 1, name: 'Leanne Graham', username: 'Bret', email: 'sincerebret@april.cz'},
    ...
    {id: 10, name: 'Clementina DuBuque', username: 'Moriah.Stanton', email: 'rebecca_okeefe@kristin.biz'}
  ];
